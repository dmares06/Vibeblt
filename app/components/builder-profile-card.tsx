...
export function BuilderProfileCard({ builder, variant = "card", viewerId, redirectTo = `/builder/${builder.username}` }: BuilderProfileCardProps) {
  ...
  return (
    ...
    >
      ...
      <div className={`relative z-10 flex flex-col gap-6 ${isHeader ? "lg:flex-row lg:items-start lg:gap-10" : ""}`}>
        {/* Avatar Section */}
        ...
        <div className="flex-1 space-y-4">
          ...
          <div className="flex flex-wrap gap-6 pt-2">
            ...
            <div className="flex flex-col">
              <span className="text-xl font-bold text-foreground">{builder.projectCount?.toLocaleString() || 0}</span>
